...
public class BodyTrackingLogger : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Debug.Log($"[QuestBody] Hips pos(m)={p:F3} rot(euler)={q.eulerAngles:F1}");
        }
        ...
        if (sendUdp && _udp != null)
        {
            ...
            string msg = $"/quest/hips {p.x:F6} {p.y:F6} {p.z:F6} {q.x:F6} {q.y:F6} {q.z:F6} {q.w:F6} {t:F6}";
